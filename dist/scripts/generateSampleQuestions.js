...
const importQuestions = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Clear existing questions (optional)
        // await Question.deleteMany({});
        // Insert sample questions
        yield question_1.default.insertMany(sampleQuestions);
        logger_1.default.info(`Successfully imported ${sampleQuestions.length} sample questions`);
        mongoose_1.default.disconnect();
    }
    catch (error) {
        logger_1.default.error('Error generating sample questions:', error);
        mongoose_1.default.disconnect();
    }
});
importQuestions();
